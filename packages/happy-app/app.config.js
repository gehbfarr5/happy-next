...
const abiFilters = process.env.ABI_FILTERS ? process.env.ABI_FILTERS.split(',').map(s => s.trim()) : undefined;
const name = { development: "Happy Next (dev)", preview: "Happy Next (pre)", production: "Happy Next" }[variant];
const bundleId = { development: "com.hitosea.happy.dev", preview: "com.hitosea.happy.preview", production: "com.hitosea.happy" }[variant];
