...
- A phone with the Happy Next app installed ([iOS (TestFlight)](https://testflight.apple.com/join/XyjvbhXe) / [Android (APK)](https://github.com/hitosea/happy-next/releases/latest))
