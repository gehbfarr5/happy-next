...
Happy Voice is the default and recommended provider. It's built into the app and ready to use immediately. See [Voice Setup](/voice/setup) for configuration details.
